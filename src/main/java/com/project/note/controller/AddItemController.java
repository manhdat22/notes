...
public class AddItemController {
    ...
    void initialize() {
        ...
        addButton.addEventHandler(MouseEvent.MOUSE_CLICKED, event -> {
            ...
            FadeTransition labelTransition = new FadeTransition(Duration.millis(2000), noNoteLabel);

            // remove
            System.out.println("Added Clicked!");

            addButton.relocate(0, 20);
            noNoteLabel.relocate(0, 85);

            addButton.setOpacity(0);
            noNoteLabel.setOpacity(0);
            ...
            try {
                ...
                AnchorPane formPane = FXMLLoader
                        .load(getClass().getResource("/com/project/note/view/addItemForm.fxml"));
